...
public class OOCSI_sending extends PApplet {
  ...
  public void handleOOCSIEvent(OOCSIEvent msg) {
    ...
    if(MODE==-1 || MODE==-3 || MODE==-4 || MODE==-5){
      if(msg.getString("function").equals("reportFinish")){
          finishlist[PApplet.parseInt(msg.getString("sender_ip"))-1]=1;
      }
    } else if(MODE==2 && PApplet.parseInt(msg.getString("sender_ip"))==numFinish+1){
      finishlist[PApplet.parseInt(msg.getString("sender_ip"))-1]=1;
    }
}
  
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "OOCSI_sending" };
    if (passedArgs != null) {
